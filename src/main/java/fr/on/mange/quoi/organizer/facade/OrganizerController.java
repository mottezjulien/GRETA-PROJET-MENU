...
public class OrganizerController {
    ...
    public ModelAndView home() {
        try {
            ...
            if(auth.getAuthorities().contains(new SimpleGrantedAuthority(USER_ROLE))) {
                ...
                modelAndView.addObject("userId", userIdDTO);
            }else{
    ...
    public ModelAndView newOrganizerForUser(@RequestParam("id") String userId) {
    ...
    public ModelAndView saveNewOrganizerForUser(@ModelAttribute("request") OrganizerDTO organizerDTO) {
        organizaterRepository.save(new OrganizerEntity(organizerDTO.getUserId(), organizerDTO.getLabel()));
